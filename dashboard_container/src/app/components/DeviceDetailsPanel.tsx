  ...
  return (
    <div className="w-full md:w-[18%] bg-gray-50 p-4 rounded-md">
      ...
      <div>
        ...
        />
        <button onClick={() => dispatch(handleSaveNotes({ cameraId: selectedCamera.id, notes: editingNotes }))} className="bg-blue-500 text-white p-2 rounded-md mt-2">Save Notes</button>
