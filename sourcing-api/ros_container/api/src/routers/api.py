...
from server import camera_management, configuration_management, driver_management, feature_control, logs, preset_management, recording_management, terminal, settings_management

router = APIRouter()

router.include_router(camera_management.router, tags=["camera_management"])
router.include_router(settings_management.router, tags=["settings_management"])
